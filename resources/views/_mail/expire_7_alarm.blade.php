                ...
                <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                    <tbody><tr>
                        ...
                        <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
							...
							<br>
							Greetings {{$userData['user']->first_name}} {{$userData['user']->last_name}}.<br>
							<br>
							Please be notified that your Elysium Insider Account will expire in 7 days.<br>
							<br>
							...
							support team at: &nbsp;support@elysiuminsider.io &nbsp;<br>
							<br>
							Username: {{$userData['user']->username}}<br>
							ID: {{$userData['user']->customer_id}}<br>
							Phone: {{$userData['user']->phone}}<br>
							E-mail: {{$userData['user']->email}}<br>
							<br>
							With warm regards,<br>
							<br>
							Your Elysium Insider support team.<br>
							<br>
