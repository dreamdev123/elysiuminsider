...
@section('content')
    ...
    <div class="row innerPagesWrapper" style=" margin-top: 0px;">
        <div class="container">
            <div class="row innerPageHead" style="min-height:200px; justify-content: center;align-self: center; margin-top: 200px;">
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <ul class="footer-menu">
                        ...
                        <li><a href="{{ route('marketing::legal::terms-of-service') }}">TERMS OF SERVICE</a></li>
